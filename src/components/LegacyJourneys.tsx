...
/**
 * 旧版旅途：按年份自动拼贴 + 手动创建旅程。旅途页改成每日手帐后收在页面底部的折叠区，
 * 展开才挂载（Codex 审核 #10：状态和新页面分开，不混用）。代码原样保留。
 */
export function LegacyJourneys() {
  ...
  return (
    <div className="journey-shell legacy-journeys">
      <div className="journey-page">
        <header className="journey-header">
          <div>
            <h2>按时间串起的旅程</h2>
            <p>旧版旅途：照片、地点和路线拼成的拼贴</p>
          </div>
